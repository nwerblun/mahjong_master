...
class MahjongHands:
    _hand_titles = np.array([
        "Hand Names",
        "2x identical chows in the same suit",
        "2x identical chows in 2 diff. suits",
        ...
        "Round wind pung",
        "Seat wind pung",
        "Concealed hand w/ discard win",
        "All chows no honors",
        "Tile hog",
        "2x pung of same number in diff. suits",
        "2x concealed pung",
        "Concealed kong",
        "All simples (2-8 only)",
        "Outside hand (term/honor in each set)",
        "Fully concealed and self draw win",
        "2x melded kong",
        "Last tile",
        "All pungs",
        ...
        "Mixed straight",
        "Reversible tiles",
        "Mixed triple chow (same chow in 3 suits)",
        "Mixed shifted pungs",
        "2x concealed kong",
        "Last tile draw",
        "Last tile claim",
    ...
    _voided_by = np.array([
        ...
        ", ".join([_hand_titles[25], _hand_titles[39], _hand_titles[41]]),
        "",  # Index 10
        "",
        "",
        ...
        ", ".join([_hand_titles[80], _hand_titles[74]]),
        "",
        "",
