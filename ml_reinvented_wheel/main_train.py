...
if __name__ == "__main__":
    ...
    if not good:
        print("Not enough bboxes to hold", str(max_objs), "objects in cell", str(grid_row), "x", str(grid_col), "in file", max_objs_file)
        img_and_label_plot(max_objs_file[:-4]+".png", highlight_cell=(grid_row, grid_col))
    else:
