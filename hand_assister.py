...
class HandAssister(Frame):
    ...
    def _debug_func(self):
        ...
        self.concealed_other_entries[2].insert(0, "b3")
        ...
        self.concealed_other_entries[6].insert(0, "c1")
        self.concealed_other_entries[7].insert(0, "c2")
        self.concealed_other_entries[8].insert(0, "c3")
        self.concealed_other_entries[9].insert(0, "c1")
        self.concealed_other_entries[10].insert(0, "c2")
        self.concealed_other_entries[11].insert(0, "c3")
